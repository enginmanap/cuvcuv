...
$(BINARY_PATH)$(EXE): $(BINARY_PATH)Model.o $(BINARY_PATH)ModelReader.o $(BINARY_PATH)MaterialReader.o  $(BINARY_PATH)Film.o $(BINARY_PATH)Octree.o $(BINARY_PATH)Light.o $(BINARY_PATH)Transform.o $(BINARY_PATH)Mat4f.o $(BINARY_PATH)Primitive.o $(BINARY_PATH)Vec4f.o $(BINARY_PATH)TriangleBase.o $(BINARY_PATH)Triangle.o $(BINARY_PATH)Ray.o $(BINARY_PATH)RayTracer.o $(BINARY_PATH)Sphere.o $(BINARY_PATH)Vec3f.o $(BINARY_PATH)Camera.o $(BINARY_PATH)Scene.o $(BINARY_PATH)SceneReader.o $(BINARY_PATH)FileReader.o $(BINARY_PATH)main.o 
	$(CXX) $^ $(LDFLAGS) -o $@
...
$(BINARY_PATH)SceneReader.o: $(SOURCE_PATH)SceneReader.cpp $(SOURCE_PATH)SceneReader.h
	mkdir -p $(BINARY_PATH)
	$(CXX) $(CXXFLAGS) $< -o $@
...
$(BINARY_PATH)TriangleBase.o: $(SOURCE_PATH)TriangleBase.cpp $(SOURCE_PATH)TriangleBase.h
	mkdir -p $(BINARY_PATH)
	$(CXX) $(CXXFLAGS) $< -o $@
